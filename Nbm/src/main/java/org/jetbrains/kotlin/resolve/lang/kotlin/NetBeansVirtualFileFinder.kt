...
class NetBeansVirtualFileFinderFactory(private val project: Project) : VirtualFileFinderFactory {
    ...
    override fun create(ideaProject: com.intellij.openapi.project.Project, moduleDescriptor: ModuleDescriptor): VirtualFileFinder =
            NetBeansVirtualFileFinder(project, GlobalSearchScope.allScope(ideaProject))
}