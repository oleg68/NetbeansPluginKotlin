...
// singletonOrEmptyList removed in 1.3.72 — use listOfNotNull
...
fun CallTypeAndReceiver<*, *>.receiverTypesWithIndex(
            ...
            if (receiver != null) {
                ...
                when (lhs) {
                    ...
                    is DoubleColonLHS.Expression -> {
                        ...
                        return receiverValueTypes(receiverValue, lhs.dataFlowInfo, bindingContext, moduleDescriptor, stableSmartCastsOnly, resolutionFacade)
    ...
    for ((receiverIndex, receiverValue) in receiverValues.withIndex()) {
        val types = receiverValueTypes(receiverValue, dataFlowInfo, bindingContext, moduleDescriptor, stableSmartCastsOnly, resolutionFacade)
...
private fun receiverValueTypes(
    ...
    return if (dataFlowValue.isStable || !stableSmartCastsOnly) {
