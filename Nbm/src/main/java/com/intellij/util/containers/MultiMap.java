...
public class MultiMap<K, V> implements Serializable {
    ...
    protected Map<K, Collection<V>> createMap(int initialCapacity, float loadFactor) {
        return new java.util.HashMap<K, Collection<V>>(initialCapacity);
    }
    ...
    public static <K, V> MultiMap<K, V> create(@NotNull final TObjectHashingStrategy<K> strategy) {
        return new MultiMap<K, V>() {
            ...
            @Override
            protected Map<K, Collection<V>> createMap() {
                return new java.util.LinkedHashMap<K, Collection<V>>();
            }
        };
    }
    ...
    public static <K, V> MultiMap<K, V> createLinked() {
        return new MultiMap<K, V>() {
            @NotNull @Override protected Map<K, Collection<V>> createMap() { return new java.util.LinkedHashMap<>(); }
        };
    }
    ...
    public static <K, V> MultiMap<K, V> createLinkedSet() {
        return new MultiMap<K, V>() {
            @NotNull @Override protected Map<K, Collection<V>> createMap() { return new java.util.LinkedHashMap<>(); }
            @NotNull @Override protected Collection<V> createCollection() { return new java.util.LinkedHashSet<>(); }
            @NotNull @Override protected Collection<V> createEmptyCollection() { return java.util.Collections.emptySet(); }
        };
    }
